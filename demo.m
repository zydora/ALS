...
% MINST
clear all;clc
Dataset = 'SVHN';%You should change the W number nodes as same.
...
%% ALS
[W,e] = ALS(W,A,Z,y,index,mc,TrainImages,TrainLabels,TestImages,TestLabels,N,MAXITER,threshold);
%% BP
